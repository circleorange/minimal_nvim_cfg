          ...
          callback = function()
            ...
            local config = {
              cmd = {
                ...
                "-jar", "/Users/piotr.bielski/.local/share/jdtls/plugins/org.eclipse.equinox.launcher_VERSION.jar",
                "-configuration", "/Users/piotr.bielski/.local/share/jdtls/config_mac",
                "-data",
                workspace_dir,
              },
              root_dir = require("jdtls.setup").find_root({ ".git", "mvnw", "gradlew", "pom.xml" }),
              settings = {
                java = { -- Any additional JDTLS settings can be added here },
              },
